...
#hardcode without locators (0) or with (1)
locators = 1

#let's hardcode the size at 5cm.  I have no intention at the moment of letting the user choose this, they can just scale the object later
axisSize = 5
